...
<section class="hero-section" style="height:500px;">
    ...
    <section class="cta-section py-5 theme-bg-secondary text-center">
      <div class="container">
        <h3 class="text-white font-weight-bold mb-3">Ready to start using traqker?</h3>
        <a class="btn theme-btn theme-btn-ghost theme-btn-on-bg mt-4" href="/register">Create a Free Account</a>
      </div>
    </section><!--//cta-section-->
@endsection